...
- la gestión activa del contexto de la sesión.
...
https://github.com/tumobilamigo-beep/TMA_Docs/tree/f795c3a96c462eb9bffbddd98bfe61e60eae49ed/Arbol%20de%20documentaci%C3%B3n/00_Gobierno_Proyecto
...
5. cómo debe mantenerse activa la gestión del contexto durante la sesión.
...
> El sistema de gestión activa del contexto determina CUÁNDO debe advertirse o prepararse una transición de sesión.
...
Si un Prompt Universal establece una forma específica de analizar, documentar, verificar, gestionar el contexto o continuar el proyecto, debes seguirla.

---

# 5. ESTRUCTURA DEL ÁRBOL DE DOCUMENTACIÓN

Después de comprender el funcionamiento de los Prompts Universales, utiliza:

FUENTE 02 — ÁRBOL DE DOCUMENTACIÓN.

Este árbol contiene la documentación general y específica del proyecto.

La estructura puede contener diferentes áreas.

No asumas que las carpetas contienen siempre la misma información.

Debes explorar la estructura real disponible.

Sigue siempre las instrucciones establecidas por los Prompts Universales.
...
Después de comprender 00_Gobierno_Proyecto, navega por las demás áreas del:
...
CURRENT.md
→ para saber DÓNDE QUEDÓ EL TRABAJO.

Historial
→ para comprender POR QUÉ se llegó al estado actual.

Gestión Activa del Contexto
→ para determinar CUÁNDO debe advertirse o prepararse una transición de sesión.

No utilices una fuente para responder preguntas que corresponden a otra si la fuente adecuada está disponible.

---

# 13. ACTIVACIÓN DE LA GESTIÓN ACTIVA DEL CONTEXTO

Una vez leído y ejecutado:

PROMPT UNIVERSAL 05 — GESTIÓN ACTIVA DEL CONTEXTO

sus reglas quedan activas durante TODA la conversación.

No debe ejecutarse solamente durante la inicialización.

Debe mantenerse como una instrucción operativa permanente de esta sesión.

Su función será:

- supervisar el crecimiento estimado del contexto;
- utilizar un contador real cuando el entorno lo proporcione;
- utilizar una estimación cuando no exista contador real;
- identificar los niveles de contexto establecidos;
- emitir las alertas correspondientes;
- recomendar la preparación de continuidad cuando sea necesario;
- recomendar el cierre de la sesión antes de alcanzar un límite crítico.

No debes inventar el número de tokens utilizados.

Toda medición que no provenga de un contador real debe identificarse como:

ESTIMACIÓN APROXIMADA.

La gestión activa del contexto NO modifica directamente:
...
Cuando el Universal 05 determine que debe prepararse una transición, deberá utilizarse el procedimiento de continuidad establecido por los demás Prompts Universales.

---

# 14. NO INVENTAR INFORMACIÓN
...
- contexto;
- uso real de tokens;
- límites de contexto no verificados.
...
# 15. NO COMENZAR EL DESARROLLO TODAVÍA
...
# 16. OBJETIVO DE ESTA INICIALIZACIÓN
...
9. cómo se gestionará activamente el contexto durante esta sesión;
10. qué procedimiento debe utilizarse si es necesario iniciar una nueva sesión.
...
6. Comprende primero la FUENTE 03 — 00_Gobierno_Proyecto.
...
10. Utiliza la FUENTE 06 cuando corresponda.
11. Mantén activa durante toda la sesión la gestión definida por el PROMPT UNIVERSAL 05.
12. No inventes información.
13. No saltes etapas.
14. No comiences el desarrollo antes de completar el procedimiento establecido.
